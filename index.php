...
navigationDropdown1.addEventListener( 'mouseout' , function(){
        ...
        <div class="causes" id="causes">
            <div class="causes__container">
                ...
                <?= $C[0]['cause_paragraph'] ?>
                    ...
                    <a href="#popup4" class="button2 cause__button">  <?= $C[0]['cause_button'] ?>
               </a>
                </div>
                <!--################################    CAUSE 2     ##############################-->
                <div class="cause">
                ...
                <?= $C[1]['cause_paragraph'] ?>
                    ...
                    <a href="#popup4" class="button2 cause__button">    <?= $C[1]['cause_button'] ?>
               </a>
                </div>
                <!--################################    CAUSE 3     ##############################-->
                <div class="cause">
    ...
    <?= $C[2]['cause_heading'] ?>
            ...
            <img src="admin/assets/ngo/<?= $C[2]['path'] ?>" alt="" class="cause__image">
                    ...
                    <a href="#popup4" class="button2 cause__button">    <?= $C[2]['cause_button'] ?>
